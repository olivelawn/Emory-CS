...
Define DataPath MIR[31..0] mbr [15..0] Phase[4..1] Reset |
...
Not ec Phase[2] notPhase[2];

Register "a-latch" ec aout[15..0] notPhase[2] | A[15..0]; 
Register "b-latch" ee bout[15..0] notPhase[2] | B[15..0]; 
